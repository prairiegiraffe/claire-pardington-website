...
interface BackgroundImageLandingPageProps {
  ...
  heroBackgroundImageDark?: string;
    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <main>
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:text-gray-400 dark:ring-white/10 dark:hover:ring-white/20">
                  {announcementText}{' '}
                  <a href={announcementHref} className="font-semibold text-indigo-600 dark:text-indigo-400">
        ...
        <div className="relative z-10 mt-32 mb-20 sm:mt-56 sm:mb-24 xl:mb-0">
          ...
          <div className="bg-gray-900 pb-20 sm:pb-24 xl:pb-0 dark:bg-gray-800/50 dark:ring-1 dark:ring-white/5">
              ...
              <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                <figure className="relative isolate pt-6 sm:pt-12">
                  ...
                  <figcaption className="mt-8 text-base">
                    ...
                    <div className="mt-1 text-gray-400">{testimonialTitle}</div>
                  </figcaption>
                </figure>
              </div>
            </div>
