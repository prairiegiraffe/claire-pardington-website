        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
            <svg
              ...
              aria-hidden="true"
              className="absolute -bottom-48 left-1/2 h-[1024px] -translate-x-1/2 translate-y-1/2 [mask:radial-gradient(closest-side,white,transparent)] lg:-top-48 lg:bottom-auto lg:translate-y-0"
            >
