    ...
    g = {
      ...
      destroy: function () {
        ...
        if ('prevented' != s('destroying', this)) {
          ...
          for (
            f(document).unbind(q.move, b.eventHandlers.touchMove).unbind(q.up, b.eventHandlers.touchEnd);
            0 !== b.totalPages;
      ...
      display: function (a) {
        ...
        switch (a) {
          case 'single':
            ...
            break;
          case 'double':
            (b.pageObjs[0] && (this.turn('stop').css({ overflow: '' }), b.pageObjs[0].remove(), delete b.pageObjs[0]),
      ...
      _eventStart: function (a, b, c) {
        ...
        a.isDefaultPrevented() ||
          (e &&
            e != d.zoom &&
            (b.turn.trigger('zoomed', [b.page, b.turn.turn('view', b.page), e, d.zoom]), (d.pageZoom[b.page] = d.zoom)),
          'single' == d.display &&
            c &&
        ...
        switch (b.effect) {
          case 'hard':
            ...
            c.opts.gradients &&
              (g
                ? b.ashadow
                    .css({ display: '', left: f, backgroundColor: 'rgba(0,0,0,' + 0.5 * o + ')' })
              ...
              H = function () {
                ...
                if (
                  ...
                  i._backGradient.call(t) &&
                    ((A = j(100 * ((1.2 * x * Math.sin(g)) / e), 100 * ((1.2 * x * Math.cos(g)) / h))),
                    B || (A.x = 100 - A.x),
                    !D))
                )
                  A.y = 100 - A.y;
