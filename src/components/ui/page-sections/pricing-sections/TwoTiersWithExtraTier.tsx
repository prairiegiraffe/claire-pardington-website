      ...
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-96 text-center sm:pt-32 lg:px-8">
        ...
        <div className="relative mt-6">
          ...
          <svg
            ...
            className="absolute -top-10 left-1/2 -z-10 h-[1024px] -translate-x-1/2 [mask:radial-gradient(closest-side,white,transparent)] sm:-top-12 md:-top-20 lg:-top-12 xl:top-0"
          >
