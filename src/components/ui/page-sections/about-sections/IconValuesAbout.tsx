      ...
      <main className="relative isolate">
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-40">
          <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/75 px-6 py-16 shadow-lg ring-1 ring-gray-900/5 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20 dark:bg-white/5 dark:shadow-none dark:ring-white/10">
              <img
                alt=""
              ...
              <div className="w-full flex-auto">
                <h2 className="text-4xl font-semibold tracking-tight text-gray-950 sm:text-5xl dark:text-white">
                  Join our team
                </h2>
                <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-400">
