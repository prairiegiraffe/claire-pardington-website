            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div className="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
                <svg
                  ...
                  aria-hidden="true"
                  className="absolute -bottom-48 left-1/2 h-64 -translate-x-1/2 translate-y-1/2 lg:-top-48 lg:bottom-auto lg:translate-y-0 opacity-30"
                >
                  <defs>
                    <radialGradient id="d25c25d4-6d43-4bf9-b9ac-1842a30a4867">
                      <stop stopColor="#7775D6" stopOpacity="0.8" />
                      <stop offset="0.5" stopColor="#E935C1" stopOpacity="0.6" />
