    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <main className="isolate">
        ...
        <div className="relative isolate -z-10">
          <svg
            aria-hidden="true"
            className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full fill-neutral-50 stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)] dark:fill-gray-800/20 dark:stroke-white/10"
          >
            <defs>
              <pattern
                x="50%"
            ...
            <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="mt-8 text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none dark:text-gray-400">
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-48">
          <div className="absolute inset-x-0 top-1/2 -z-10 flex -translate-y-1/2 justify-center overflow-hidden [mask-image:radial-gradient(50%_45%_at_50%_55%,white,transparent)]">
            <svg aria-hidden="true" className="h-[40rem] w-[128.75rem] flex-none stroke-gray-200 dark:stroke-white/10">
              <defs>
                <pattern
                  x="50%"
                  y="50%"
              ...
              <svg x="50%" y="50%" className="overflow-visible fill-gray-50 dark:fill-gray-800/20">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              ...
              <img
                ...
                width={158}
                height={48}
                className="col-span-2 max-h-12 w-full object-contain hidden dark:block lg:col-span-1"
              />
              ...
              <img
                ...
                width={158}
                height={48}
                className="col-span-2 max-h-12 w-full object-contain hidden dark:block sm:col-start-2 lg:col-span-1"
              />
              ...
              <img
                ...
                width={158}
                height={48}
                className="col-span-2 col-start-2 max-h-12 w-full object-contain hidden dark:block sm:col-start-auto lg:col-span-1"
              />
            </div>
          </div>
        </div>
